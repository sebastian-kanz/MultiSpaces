...
contract Element is IElement, Initializable, ParticipantManagerAdapter {
    ...
    function _setRedundancyLevel(LibElement.RedundancyLevel level) private {
